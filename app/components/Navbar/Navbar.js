...
const navigation = [
    ...
    { name: "Experties", href: "#gallery-section", current: false },
    { name: "Projects", href: "#cook-section", current: false },
                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex sm:hidden flex-shrink-0 items-center border-right">
                                ...
                                <img src={ekantikLogo} alt="logo" width={36} height={36} />
                            </div>
                            <div className="hidden sm:flex flex-shrink-0 items-center border-right">
                                <Image src={ekantikLogo} alt="logo" width={56} height={56} />
                            </div>
                            ...
                            <div className="gap-6 hidden lg:flex">
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-lg font-medium">(+91) 7433 804 998</p>
                                </div>
