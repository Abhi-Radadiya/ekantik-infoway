...
const cardData = [
    {
        ...
        subheading: "Blurring the line between web and native mobile applications",
        link: "Learn more",
    },
    {
        imgSrc: "/images/Features/featureTwo.svg",
        heading: "System integration",
        subheading: "Seamlessly connecting and optimizing diverse software systems within an organization",
        link: "Learn more",
    },
    {
        imgSrc: "/images/Features/featureThree.svg",
        heading: "Software as a service",
        subheading: "Cloud-based software distribution model that provides users with access to applications ",
        link: "Learn more",
    },
    {
            ...
            <div className="mx-auto max-w-7xl py-40 px-6" id="about-section">
                <div className="text-center mb-14">
                    <Fade direction={"up"} delay={400} cascade damping={1e-1} triggerOnce={true}>
                        <h3 className="text-pink text-lg font-normal mb-3 ls-51 uppercase">Our Experties</h3>
                    </Fade>
                    <Fade direction={"up"} delay={800} cascade damping={1e-1} triggerOnce={true}>
                        <p className="text-3xl lg:text-5xl font-semibold text-lightgrey">
                            Get a key to future of <br /> softwares
                        </p>
                    </Fade>
                </div>

                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-5 mt-32 -mx-[150px]">
